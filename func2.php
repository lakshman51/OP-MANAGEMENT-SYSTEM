...
if(isset($_POST['patsub1'])){
  ...
  if($password==$cpassword){
    $q1="SELECT email FROM patreg WHERE email='$email'";
    ...
    if($c > 0)
    {
  	...
  	$query="insert into patreg(fname,lname,gender,email,contact,password,cpassword,age,address) values ('$fname','$lname','$gender','$email','$contact','$password','$cpassword','$age','$address');";
